...
export const HoverEffect = ({ items = [], className }) => {
  ...
  return (
    <section className="py-10 bg-[#6D9672]">
      <h1 className="md:text-4xl text-xl  text-black text-center text-wrap break-words    relative z-20">
        Challenges faced by the <br />
        business teams today
      </h1>
      <p className="text-center text-xl mx-14 mt-5    relative z-20">
...
export const CardTitle = ({ className, children }) => {
  return (
    <h4 className={cn("text-black   tracking-wide mt-4", className)}>
      {children}
    </h4>
  );
};
